...
%
% After this data from all three runs is loaded concatenated and ICA
...
rawfile = sprintf('D:\\ASD_Data\\raw_PS_data\\trans\\rs_asd_%s_pers%s_tsss.fif',num2str(subject),PS_run);
...
% to remove due to an incorrect response. Refer to partiicpant EDAT files
